...
import { Table, Radio, Checkbox, Space, Tag, Button } from "tdesign-react";
import {
...
export default function TableCustomColButton() {
  ...
  const tableNode = (
    <Table
      ...
      //     ? { content: "显示列控制", theme: "primary", variant: "base" }
      //     : undefined,
      // }}
      columnController
  ...
  return (
    <Space direction="vertical" size="large">
      ...
      {tableNode}
      <Button onClick={onBtnClick}>变化列</Button>
    </Space>
  );
}
